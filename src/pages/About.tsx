      ...
      <section style={{ background: 'var(--bg-2)' }}>
        <div className="container">
          ...
          <div className="values">
            ...
            <div className="value reveal"><div className="v-icon">05</div><h3>Curious always</h3><p>From AI to data to design, we're always learning and evolving - so your business gets the best of what's possible today.</p></div>
            <div className="value reveal"><div className="v-icon">06</div><h3>No Layers</h3><p>You work directly with the people building your project. No middlemen, no handoffs, no broken telephone.</p></div>
          </div>
        </div>
      </section>
